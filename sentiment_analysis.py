...
# Read the csv file
df = pd.read_csv('data/amazon_product_reviews.csv')
...
# Define analyze_sentiment(sentence) function to analyze sentiment using TextBlob
...
polarity_score, sentiment = analyze_sentiment(clean_review1)
print(f"Review: {clean_review1}")
print(f"Polarity score: {polarity_score}")
print(f"Sentiment: {sentiment}\n")

# Get polarity_score and sentiment for second example
polarity_score, sentiment = analyze_sentiment(clean_review2)
